...
public class CloseSession extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CloseSession\",\"namespace\":\"Energistics.Protocol.Core\",\"fields\":[{\"name\":\"reason\",\"type\":[\"null\",\"string\"]}],\"messageType\":\"5\",\"protocol\":\"0\",\"senderRole\":\"client,server\",\"protocolRoles\":\"client,server\"}");
