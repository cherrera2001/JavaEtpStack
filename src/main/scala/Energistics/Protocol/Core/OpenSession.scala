...
case class OpenSession(var applicationName: String, var applicationVersion: String, var sessionId: String, var supportedProtocols: List[SupportedProtocol], var supportedObjects: List[String]) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      case 2 => this.sessionId = {
        value.toString
      }.asInstanceOf[String]
      case 3 => this.supportedProtocols = {
        value match {
